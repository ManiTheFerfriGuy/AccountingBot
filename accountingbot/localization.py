...
_LANGUAGES = {
    "en": LanguagePack(
        ...
        texts={
            ...
            "start_command_overview": "Choose an option below or use a command for quick access:",
            "start_search_hint": "Need an ID quickly? Tap \"Find a Record\" or send /search <name>.",
            "start_cancel_hint": "To stop an action, tap Cancel or send /cancel at any time.",
    ...
    "fa": LanguagePack(
        ...
        texts={
            ...
            "start_command_overview": "از دکمه‌های زیر استفاده کنید یا در صورت تمایل دستور را مستقیماً بفرستید:",
            "start_search_hint": "به‌دنبال شناسه هستید؟ روی «جستجوی سوابق» بزنید یا ‎/search <نام> را ارسال کنید.",
            "start_cancel_hint": "برای توقف عملیات روی دکمه انصراف بزنید یا هر زمان ‎/cancel را بفرستید.",
